    ...
    <div class="content">
      <div class="content_bg">
        ...
        <div class="hbg"><img src="images/header_images.JPG" width="915" height="286" alt="" /></div>
      				<center>
<form name="f1" method="post" action="Patient" onsubmit="return validate(this);"><br/>
   <h2><b>Patient Login Screen</b></h2>
	...
	if(res != null){
		out.println("<center><font face=verdana color=red>"+res+"</center></font>");
			 ...
			 <tr><td><b>Patient&nbsp;ID</b></td><td><input type="text" name="t1" style="font-family: Comic Sans MS" size=20/></td></tr>
         
		   <tr><td><b>Random&nbsp;No</b></td><td><input type="password" name="t2" style="font-family: Comic Sans MS" size=20/></td></tr>		   
