...
<script language="javascript">
	...
	{
	alert("Please Enter date&time of registration");
	formObj.t2.focus();
	return false;
	}
    ...
    <div class="content">
      <div class="content_bg">
        ...
        <div class="hbg"><img src="images/header_images.JPG" width="915" height="286" alt="" /></div>
      				<center>
<form name="f1" method="post" action="HealthcareUpload" onsubmit="return validate(this);"><br/>
   <h2><b>Patient Profile Screen</b></h2>
	...
	if(res != null){
		out.println("<center><font face=verdana color=red>"+res+"</center></font>");
		  ...
		  <tr><td><b>Date&Time</b></td><td><input name="t2" type="Text" id="demo1" maxlength="25" size="20" class="c2" ><a href="javascript:NewCal('demo1','ddmmmyyyy',true,24)"><img src="cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
