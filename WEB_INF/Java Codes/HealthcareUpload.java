...
public void doPost(HttpServletRequest request, HttpServletResponse response)	throws ServletException, IOException {
	...
	try{
		...
		if(!msg.equals("fail")){
			...
			RequestDispatcher rd=request.getRequestDispatcher("AdminScreen.jsp?t1=Your Profile created.<br/>Patient ID = "+arr[1]+"<br/>Generated Random No : "+arr[2]);
			rd.forward(request, response);
		}
		else{
			response.sendRedirect("AdminScreen.jsp?t1=Error in creating pfofile");
		}
