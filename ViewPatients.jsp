   ...
   <h2><b>View Patients Details Screen</b></h2>
	...
	if(res != null){
		out.println("<center><font face=verdana color=red>"+res+"</center></font>");
			...
			<tr><th><font size="3" color="black">Patient ID</th><th><font size="3" color="black">Patient Name</th><th><font size="3" color="black">Date</th>
			<th><font size="3" color="black">Age</th><th><font size="3" color="black">Gender</th><th><font size="3" color="black">Contact No</th>
			<th><font size="3" color="black">Address</th><th><font size="3" color="black">Problem</th>
	...
	<td><font size="3" color="black"><%=DBConnection.anonymity(rs.getString(2))%></td>
